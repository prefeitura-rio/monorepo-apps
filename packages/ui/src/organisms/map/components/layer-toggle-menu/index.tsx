...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from '@ed-rio/ui/molecules/collapsible'
import { Toggle } from '@ed-rio/ui/molecules/toggle'
import { AnimatePresence, motion } from 'framer-motion'
import { ChevronUp, Layers } from 'lucide-react'
import { useState } from 'react'

import type { LayerToggleMenuItem } from '../../types'

interface LayerToggleMenuProps {
  layers: LayerToggleMenuItem[]
}

export function LayerToggleMenu({ layers }: LayerToggleMenuProps) {
